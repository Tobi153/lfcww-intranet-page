...
function LayoutContent() {
  ...
  return (
    ...
    >
      ...
      <MobileNav />
      <div
        className={`grid px-8 pr-8 md:pr-5 py-8 mx-auto grid-cols-1 ${isTutorialActive ? "lg:grid-cols-[30%_60%] xl:grid-cols-[25%_70%] 2xl:grid-cols-[22.5%_74.5%]" : ""}  w-full  ${!isTutorialActive ? "lg:grid-rows-[0.05fr_1fr_1fr]" : ""}   xl:grid-cols-[25%_43%_25%] 2xl:grid-cols-[22.5%_50%_22.5%] xl:grid-rows-[auto_1fr] max-w-[2000px]  gap-x-10 gap-y-5  mx-auto lg:mx-auto`}
      >
